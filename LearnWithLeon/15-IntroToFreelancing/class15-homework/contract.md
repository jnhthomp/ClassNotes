...
You ([customer name]), located at [customer address] (“You”) are hiring me (Jonah Thompson) (“Me”) to:
...
By default I deliver pages developed from HTML markup, CSS stylesheets for styling and JavaScript for behavior. I can also offer web applications created with the React JavaScript framework. If you'd like me to build a React web application for you, I can provide a seperate estimate.
...
If you need changes or updates to the site in the future after the completion of this project feel free to contact me and I can provide an estimate for those changes.
...
I issue invoices electronically. My payment terms are [7] days from the date of invoice by Venmo or PayPal. All proposals are quoted in US dollars.
