...
The teacher uses the previously completed custom hook
Go back and review previous lessons if you are unsure how that is implented or why it works

For the form he follows the exact same pattern as in the previous lectures leading up to here
It also is almost identical to my approach (outide of some very slight differences) so I will not record the entire process

See the github for the finished version of the teachers approach
github: https://github.com/academind/react-complete-guide-code/tree/16-working-with-forms/code/11-applying-our-hook-and-knowledge
